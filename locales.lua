local locales = {
  ...
  ["ruRU"] = {
    ...
    ["Completed Level"] = "Завершено на уровене",
    ["Config"] = "Настройки",
    ...
    ["Draw Favorites On Login"] = "Отображать в базе данных избранное при входе в игру",
    ...
    ["Minimum Item Drop Chance"] = "Искать предметы в БД с шансом выпадения не ниже",
