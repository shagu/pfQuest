local locales = {
  ...
  ["ruRU"] = {
    ...
    ["Display Current Quest Givers"] = "Показать текущих квестодателей",
    ["Display Event & Daily Quests"] = "Показать события и ежедневные задания",
    ["Display Level+3 Quest Givers"] = "Показать уровень+3 квестодателей",
    ...
    ["Draw Favorites On Login"] = "Показать избранное при входе в систему",
    ["Enable Minimap Button"] = "Включить кнопку на миникарте",
    ["Enable Minimap Nodes"] = "Включить узлы на миникарте",
    ["Enable Quest Link Support"] = "Включить поддержку Ссылка на квест",
    ["Enable Quest Log Buttons"] = "Включить кнопки журнала заданий",
    ["Enable Quest Tracker"] = "Включить отслеживание заданий",
    ["Enable World Map Menu"] = "Включить меню карты мира",
    ...
    ["Highlight Nodes On Mouseover"] = "Выделение узлов при наведении курсора мыши",
    ...
    ["Include Quest Enders"] = "Включить завершающих задания",
    ["Include Quest Starters"] = "Включить начинающих задания",
    ["Include Unified Quest Locations"] = "Включая объединенные локации заданий",
    ...
    ["Minimum Item Drop Chance"] = "Минимальный шанс выпадения предмета",
    ...
    ["Show all taxi nodes of [faction]"] = nil,
    ["Show Arrow Along Routes"] = "Показывать стрелку вдоль маршрутов",
    ["Show configuration interface"] = "Показать интерфейс настройки",
    ["Show Database IDs"] = "Показать идентификаторы базы данных",
    ["Show database interface"] = "Показать интерфейс базы данных",
    ["Show Help On Tooltips"] = "Показать справку во всплывающих подсказках",
    ...
    ["Trigger"] = "Триггер",
    ["Type"] = "Тип",
    ["Unified Quest Location Markers"] = "Объединенные маркеры местонахождения заданий",
    ["Units"] = "Единицы",
    ["Use |cff33ffcc%s|r at |cff33ffcc%s|r"] = "Использовать |cff33ffcc%s|r на |cff33ffcc%s|r",
    ["Use Cut-Out Minimap Node Icons"] = "Использовать вырезанные значки узлов миникарты",
    ["Use Cut-Out World Map Node Icons"] = "Использовать вырезанные значки узлов карты мира",
